...
- **Supported:** solid on solid; solid on single gradient; single gradient on solid.
- **Explicitly unsupported:** dual gradients; image fills; mixed or complex paint stacks.
...
- **[v2.0.0 changelog](https://github.com/marklearst/a11y-companion-widget/blob/main/CHANGELOG.md)**
