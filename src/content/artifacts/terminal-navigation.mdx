...
> **Historical experiment.** This article documents an earlier terminal-overlay implementation. Current portfolio navigation uses native links and Next.js routing. A small status indicator can appear while a route loads; it never delays navigation.
