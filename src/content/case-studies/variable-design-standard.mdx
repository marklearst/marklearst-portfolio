...
<CaseStudySection title="Govern variables across brands">
  <div className="space-y-6">
    <CaseStudyParagraph>
      After building <a href="/work/aurora-gm">Aurora at GM</a> across 4 brands, I wanted a governance layer
      on an existing format that could handle multiple brands without adding
      complexity. The JSON file set is the API surface: file paths and variable
      names form the contract, and a rename is a breaking change.
    </CaseStudyParagraph>

    <CaseStudyDetails summary="Naming, handoff, and layer proliferation">
    <CaseStudyParagraph>
      Teams use different terms: design tokens, style properties,
    ...
    <CaseStudyMutedList className='space-y-3'>
      ...
      <li>
        ...
        extra surfaces to audit. Variables should be easy to reason about, without
        requiring a specialist to untangle.
      </li>
    </CaseStudyMutedList>
    </CaseStudyDetails>
  </div>
...
<CaseStudySection title="Treat variable names as an API">
  <div className="space-y-6">
    <CaseStudyParagraph>
      ...
      versioning strategy, and adapter patterns for handoff as teams and
      products grow. It uses three layers and selects files for each brand,
      without extra reference hops.
    </CaseStudyParagraph>
    ...
    <CaseStudySubheading>Governance checks</CaseStudySubheading>
    <CaseStudyMutedText>
    ...
    <CaseStudyDetails summary="JSON contract and adapter examples">
...
/>
    ...
    <CaseStudySubheading>Adapter examples</CaseStudySubheading>
...
<CaseStudySection title="Select files instead of adding mapped layers">
  <div className="space-y-6">
    <CaseStudyParagraph>
      Some approaches add <em>mapped</em> collections between base and semantic
      layers to handle brand switching. As those collections multiply, tracing
      the value that renders can require a specialist.
    </CaseStudyParagraph>
    <CaseStudyParagraph>
      In VDS, <strong>file selection replaces mapped layers</strong>. JSON
      provides structure, folders organize each brand's values, and CSS
      <code>@layer</code>, <code>@import</code>, and the cascade handle
      consumption.
    </CaseStudyParagraph>

    <CaseStudyMutedText>
      Brand selection happens by file list, not by mapped collections in a
      design tool panel. Selecting a brand folder changes the values while
      preserving the semantic names.
    </CaseStudyMutedText>

    <CaseStudySubheading>Brand file selection</CaseStudySubheading>
...
/>
    ...
    <CaseStudyDetails summary="Mapped layer costs and brand-selection examples">
    <CaseStudySubheading>Mapped layer costs</CaseStudySubheading>
    <CaseStudyMutedText>
...
/>
    ...
    <CaseStudySubheading>Review and resolution</CaseStudySubheading>
    <CaseStudyMutedList className="space-y-2">
    ...
    <CaseStudySubheading>Version control and build inputs</CaseStudySubheading>
    <CaseStudyMutedText>
...
<CaseStudySection title="Validate changes before merge">
  <div className="space-y-6">
    <CaseStudyMutedText>
    ...
    <CaseStudyMutedText>
      VDS requires validation before a change merges:
    </CaseStudyMutedText>
    <CaseStudyMutedList className="space-y-2">
    ...
    <CaseStudyDetails summary="DTCG types, versioning rules, and deprecation example">
    <CaseStudySubheading className="mt-0">DTCG 2025.10 types</CaseStudySubheading>
...
/>
    ...
    <CaseStudySubheading>Versioning and deprecation</CaseStudySubheading>
    <CaseStudyMutedText>
...
<CaseStudySection title="Where the specification ends">
  <div className="space-y-6">
    <CaseStudyParagraph>
      I publish VDS as a living governance specification informed by design
      systems work. It defines naming, validation, versioning, and adapter
      patterns on DTCG 2025.10. The intended contract outlives an individual
      design tool and stays in version control.
    </CaseStudyParagraph>

    <CaseStudyMutedText>
      VDS is not a new file format, a runtime library, or a design system. It
      governs variables and their changes; it does not choose a team's design
      decisions. Validation happens at build time. The three-layer constraint
      keeps the contract explicit rather than adding another abstraction layer.
    </CaseStudyMutedText>

    <CaseStudyMutedText>
      The specification describes what a conforming workflow must check.{' '}
      <a href="/work/primitree">Primitree</a> is where I implement token
      architecture checks, build output, and change reports. Keeping the
      specification and the tool separate makes each responsibility reviewable.
    </CaseStudyMutedText>
  </div>
</CaseStudySection>
