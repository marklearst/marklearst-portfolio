...
<CaseStudySection title="Govern variables across brands">
  <div className="space-y-6">
    <CaseStudyParagraph>
      After building Aurora at GM across 4 brands, I wanted a governance layer
...
<CaseStudySection title="Specification scope and status">
  <div className="space-y-6">
    <CaseStudyParagraph className='mt-8'>
      ...
      their tool stack. The contract should outlive any tool choice.
    </CaseStudyParagraph>
    ...
    <CaseStudyDetails summary="Specification scope and intended outcomes">
    ...
    <CaseStudyMutedList className='space-y-4'>
      ...
      <li>
        <strong>Governs breaking changes</strong> through SemVer, deprecation
        strategy, and CI validation before merge
      </li>
      <li>
        <strong>Scales to multi-brand</strong> with file selection rules that
        keep one semantic name set across brands without intermediate layers
      </li>
      <li>
