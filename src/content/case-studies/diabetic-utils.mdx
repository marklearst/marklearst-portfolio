...
<CaseStudySection title="Extract the calculations I kept rewriting">
  <div className="space-y-6">
    <CaseStudyParagraph>
      ...
      functions. I wanted those calculations in one tested TypeScript library
      that other diabetes developers could use.
    </CaseStudyParagraph>
...
<CaseStudySection title="Test calculations and edge cases">
  <div className="space-y-6">
    ...
    <CaseStudySubheading>One API for explicit units</CaseStudySubheading>
    <CaseStudyMutedText>
    ...
    <CaseStudyDetails summary="Conversion, A1C, and Time in Range API reference">
