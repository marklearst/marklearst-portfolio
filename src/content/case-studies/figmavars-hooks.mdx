...
<CaseStudySection title="Package capabilities and status">
  <div className="space-y-6">
    ...
    <CaseStudyMutedText>
      This work became the starting point for <a href="/work/primitree">Primitree</a>,
      which adds architecture rules, token graphs, generated output, and change
      reports around the variable data.
    </CaseStudyMutedText>
  </div>
</CaseStudySection>
