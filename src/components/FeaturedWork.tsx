      ...
      <div className={styles.container}>
        ...
        {SHOWCASES.map((project, index) => (
          <article key={project.slug} className={`${styles.project} ${index % 2 ? styles.projectReversed : ''}`}>
            ...
            <figure className={styles.figure}>
              ...
              <figcaption className={styles.caption}>{project.caption}<span aria-hidden='true'><ArrowRightIcon /></span></figcaption>
            </figure>
          </article>
        ))}
        ...
        <div className={styles.practice}>
          <div>
            ...
            <Link href='/artifacts/agentic-workflows' className={styles.caseLink}>Read the workflow <span aria-hidden='true'><ArrowRightIcon /></span></Link>
          </div>
        ...
        <div className={styles.moreWork}>
          ...
          <Link href='/work/skydio'>Skydio <span aria-hidden='true'><ArrowRightIcon /></span></Link>
