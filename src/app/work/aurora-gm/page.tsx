      ...
      sections={[
        ...
        },
        {
          ...
          content: (
            <div className='space-y-6'>
              <p className='text-lg leading-relaxed'>
                I led the design and implementation of <strong>Aurora</strong>—GM's first cross-brand design system—serving as the single source of truth for React components across web and native platforms.
              </p>
          ...
          content: (
            <div className='space-y-6'>
              ...
              <ul className='space-y-4 ml-6 list-disc' style={{ color: `${MONOKAI.foreground}b3` }}>
                <li>
                  <strong style={{ color: MONOKAI.foreground }}>60% component reuse</strong> across Chevrolet, Buick, GMC, and Cadillac—eliminating duplicated work and accelerating feature delivery
                </li>
                <li>
                  <strong style={{ color: MONOKAI.foreground }}>30% faster release velocity</strong> as teams stopped rebuilding components and started composing from Aurora
                </li>
                <li>
                  <strong style={{ color: MONOKAI.foreground }}>WCAG 2.1 AA compliance</strong> embedded into design-to-code workflows, expanding user reach by making all digital experiences accessible
                </li>
                <li>
                  <strong style={{ color: MONOKAI.foreground }}>40% reduction in onboarding time</strong> for new engineers and designers joining GM's digital teams
                </li>
                <li>
                  <strong style={{ color: MONOKAI.foreground }}>Unified design-code handoff</strong> through automated token pipelines, removing manual translation steps
                </li>
              </ul>
