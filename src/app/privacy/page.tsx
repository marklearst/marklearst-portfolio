...
export default function PrivacyPage() {
  return (
    <main
      className='min-h-screen px-6 py-32 relative overflow-hidden'
      ...
      <div className='max-w-4xl mx-auto relative z-10'>
        ...
        <div className='mb-12'>
          ...
          >
            ...
            projects resonate. Data is anonymous and aggregated. No cookies, no
            ads, and no cross-site tracking.
          </p>
        </div>

        <div className='space-y-10'>
          <section>
            <h2 className='text-xl font-mono lowercase mb-3'>what i collect</h2>
            <ul
          ...
          <section>
            ...
            >
              ...
              "analytics on/off" toggle in the footer. Your preference is stored
